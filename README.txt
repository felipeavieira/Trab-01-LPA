...
Autores:	Felipe de Almeida Vieira - Nº USP: 9312686 - GitHub User Name: felipeavieira
...
foi utilizada, além da já citadas, a biblioteca math.h. As bibliotecas estão localizadas na pasta "Bibliotecas",
...
Acessando o código por um IDE, a compilação pode ser feita clicando no botão Build (ou Compile, no caso do Dev-C++),
localizado na barra de tarefas. Ele irá compilar o programa, criando um arquivo executável na mesma pasta em que se 
encontra o código fonte. Agora você poderá usar somente o executável, sem a necessidade de carregar o código.
...
um número e apertando enter, e o programa retornará a menor distância e os pares com menor distância entre eles.
No caso de várias entradas iguais, como {5,5,5,5,5}, o programa retornará a distancia 0 entre 5 e 5,
somente um vez.
